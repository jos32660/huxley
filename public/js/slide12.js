...
var speed = 500;
var delay = 2000;
var cnt = 0;				// Ajax로 가져온 슬라이드 갯수 (Index)
var html = ["", ""];
...
var bannerCss = getComputedStyle(document.querySelector(".banners"));
console.log(bannerCss["height"]); 	//이 시점에선 이미지를 로딩이 되지 않아 계산되지 않음.
setTimeout(function(){
	console.log(bannerCss["height"]);	//배너안의 높이가 생성된다음 계산된 height값이 나옴.
},500);
*/